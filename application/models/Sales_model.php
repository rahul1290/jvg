...
class Sales_model extends CI_Model{
    ...
    function bill_list($data){
        $this->db->select('s.*,st.state_name,vm.vendor_name,DATE_FORMAT(s.invoice_date,"%d/%m/%Y") as invoice_date');
        $this->db->join('vendor_master vm','vm.vendor_id = s.vendor_id','left');
    ...
    function sales_order_list(){
        ...
        $this->db->order_by('so.bill_date','desc');
    ...
    function sales_order_update($data,$bill_no){
